...
type Booking struct {
	...
	Payment       *PaymentWithRelation `json:"-,omitempty" gorm:"foreignKey:BookingID;constraint:OnDelete:CASCADE"`
	Cancellation  *Cancellation        `json:"-,omitempty" gorm:"foreignKey:BookingID;constraint:OnDelete:CASCADE"`
	TicketUsage   *TicketUsageStatus   `json:"-,omitempty" gorm:"foreignKey:BookingID;constraint:OnDelete:CASCADE"`
	Refund        *Refund              `json:"-,omitempty" gorm:"foreignKey:BookingID;constraint:OnDelete:CASCADE"`
}
...
type BookingRepository interface {
	GetManyProvider(ctx context.Context) ([]*Booking, error)
